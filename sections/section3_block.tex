...
\begin{figure}[H]
    \centering
    \includegraphics[inkscapelatex=false, width=1.1\linewidth]{sections/fig_blockpintuho/block.jpg}
    \caption{ブロック操作機能}
    \label{fig:block1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[inkscapelatex=false, width=1.1\linewidth]{sections/fig_blockpintuho/block2.jpg}
    \caption{非表示処理機能}
    \label{fig:block2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[inkscapelatex=false, width=1.1\linewidth]{sections/fig_blockpintuho/unblock.jpg}
    \caption{ブロック解除機能}
    \label{fig:block3}
\end{figure}
