...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{sections/fig_pinpost_business/pinpost_bus1_2.jpg}
    \caption{投稿を取りやめる}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{sections/fig_pinpost_business/pinpost_bus1_3.jpg}
    \caption{位置情報を地図表で選択}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{sections/fig_pinpost_business/pinpost_bus3.jpg}
    \caption{時間情報登録機能}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{sections/fig_pinpost_business/pinpost_bus5.jpg}
    \caption{投稿追加機能}
