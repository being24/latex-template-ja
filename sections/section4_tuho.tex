...
\begin{figure}[H]
        \centering
        \includesvg[inkscapelatex=false, width=1.1\linewidth]{sections/fig_blockpintuho/tuho.svg}
        \caption{通報機能}
        \label{fig:report3}
\end{figure}
...
\begin{figure}[H]
        \centering
        \includesvg[inkscapelatex=false, width=1\linewidth]{sections/fig_blockpintuho/tuho2_jigyo.svg}
        \caption{通報機能}
        \label{fig:report3}
\end{figure}